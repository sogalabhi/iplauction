  ...
  return (
    <div className="p-8 font-sans space-y-6">
      ...
      {mostExpensiveTeam?.team_name && <div
        className="flex flex-col mb-6 bg-white text-black backdrop-blur-lg rounded-lg shadow-lg border border-white/20 p-6 hover:scale-105 transition-all duration-300"
      >
